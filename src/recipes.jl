...
function Makie.convert_arguments(P::Type{<:Makie.QQNorm}, x::MixedModel, args...; qqline=:R,
                                 kwargs...)
    ...
    return convert_arguments(QQPlot, Distributions.Normal(0, 1), residuals(x), args...;
                             qqline=qqline, kwargs...)
end
function Makie.convert_arguments(P::Type{<:Makie.QQPlot}, d::Distributions.Distribution,
                                 x::MixedModel, args...; kwargs...)
