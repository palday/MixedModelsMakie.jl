...
# ╔═╡ 6a785dbe-c3be-4100-a866-d6a1e0ec6456
coeftable(fm1)

# ╔═╡ 1130191f-298d-45b1-abd3-83a5ee7c1028
...
# ╔═╡ 2b57dea8-f419-4ddb-a408-eac5f7d5a22d
"""
...
# ╔═╡ c299cc80-8bdd-4f07-a387-6937884c30de
_npreds(x::MixedModelBootstrap) = length(first(x.fits).β)

# ╔═╡ 43bf7950-b0ef-4f30-a346-75584fc0d472
_npreds(x::MixedModel) = length(coefnames(x))

# ╔═╡ 73ea9087-fe09-4ea2-b3c5-99bc2d0f58ba
"""
...
# ╔═╡ dc20cb28-b88f-46a1-ad43-8a14537b2465
coefplot(boot)
