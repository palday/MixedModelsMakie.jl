...
@testset "shrinkageplot" begin
    ...
    save(joinpath(OUTDIR, "shrinkage_kb07_subj_cols.png"), f)

    @test_throws ArgumentError("At least two columns must be specified.") shrinkageplot(m2; ellipse=true, cols=["spkr: old"])
